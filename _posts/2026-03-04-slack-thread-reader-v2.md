...
컨텍스트 윈도우가 부족해서 잘리는 상황을 생각해봐도 오름차순이 유리합니다. LLM은 긴 입력의 중간부를 놓치기 쉽다는 연구 결과가 있는데(lost in the middle), 오름차순이면 최신 내용 -- 결론이나 합의 사항 -- 이 입력의 끝에 위치해서 주의가 분산되는 영역을 피할 수 있습니다.
